...
import { isLogin, STATUS_LOGIN } from "../../util";
...
// DOM
const rutina_layout = document.querySelector('.rutina_layout')
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    `
        ...
        rutina_layout.innerHTML = content;
        rutina_layout.classList.remove('hidden');
